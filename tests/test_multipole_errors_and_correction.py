...
def test_multipole_errors_and_correction():
    ...
    env.to_json('lhc_test_multipolar_errors_corrected.json')
        ...
        for arc in ['12', '23', '34', '45', '56', '67', '78', '81']:
            ...
            for nn in tt_test_arc.name:
                ...
                if nn in {'ms.29l2.b2', 'ms.33l2.b2', 'ms.33r1.b2', 'ms.29r1.b2',
                        ...
                        'ms.29l6.b2', 'ms.33l6.b2', 'ms.33r5.b2', 'ms.29r5.b2',
                        'ms.28l7.b2', 'ms.32l7.b2', 'ms.34l7.b2', 'ms.30r6.b2',
                        'ms.29l8.b2', 'ms.33l8.b2', 'ms.33r7.b2', 'ms.29r7.b2',
                        'ms.28l1.b2', 'ms.32l1.b2', 'ms.34l1.b2', 'ms.30r8.b2'}:
                    ...
                    continue
                if nn in {'mco.b30r3.b2', 'mco.11l1.b2', 'mco.12l1.b2'}:
...
def test_multipole_errors_triplet_against_ref():
...
def test_arc_corrections_against_ref():

    env_test = xt.load('lhc_test_multipolar_errors_corrected.json')
    env_ref = xt.load(test_data_dir /
    ...
    for line_name in ['lhcb1', 'lhcb2']:
        ...
        nlchr_test = line_test.get_non_linear_chromaticity(delta0_range=(-5e-4, 5e-4),
                                                        num_delta=20)
        nlchr_ref = line_ref.get_non_linear_chromaticity(delta0_range=(-5e-4, 5e-4),
                                                        num_delta=20)
        ...
        nlchr_test_no_corr = line_test.get_non_linear_chromaticity(
            num_delta=20, delta0_range=(-5e-4, 5e-4))
...
def test_assert_are_same_multipoles_b1_b2():
