...
collider = xt.load('collider_01_bb_off.json')

# Load reference model for closed orbit correction
lhc_co_ref = xt.load('lhc_co_ref.json')
...
for line_name in ['b1', 'b2']:
    ...
    xm.machine_tuning(line=collider[line_name],
        ...
        targets=targets,
        line_co_ref=lhc_co_ref[line_name],
