...
fp_polar_no_rescale = collider['b1'].get_footprint(nemitt_x=2.5e-6, nemitt_y=2.5e-6)

fp_polar_with_rescale = collider['b1'].get_footprint(
...
fp_ua_with_rescale = collider['b1'].get_footprint(
    nemitt_x=2.5e-6, nemitt_y=2.5e-6,
