...
def build_sequence(mad, mylhcbeam, **kwargs):
    ...
    mad.input('''
      ...
      if (mylhcbeam<4){
        call,   file="run3aper/layout_2025.seq";
        call,   file="run3aper/layout_2025_corrections.madx";
      } else {
        call,   file="run3aper/layout_2025_b4_part1.seq";
        call,   file="run3aper/layout_2025_b4_part2.seq";
        call,   file="run3aper/layout_2025_corrections_b4.madx";
      };
