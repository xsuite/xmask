...
\paragraph{Skew sext (a3).} Same projection, but with the $a3$ weights (which include $D_x$):
\[
a3_{\mathrm{loc}}(s) = -\frac{\sum_i a3_c^i(s)\,a3_b^i(s)}{\sum_i (a3_c^i(s))^2},\qquad
a3_{\mathrm{res}}^i \mathrel{+}= a3_{\mathrm{loc}}(s)\,a3_c^i(s)+a3_b^i(s).
\]
